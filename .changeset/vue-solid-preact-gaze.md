...
"@blobatar/react": patch
---

Add `@blobatar/vue/gaze`, `@blobatar/solid/gaze` and `@blobatar/preact/gaze`. Every adapter can now reach the pointer-driven gaze layer, under the shape its framework reaches an element with.
