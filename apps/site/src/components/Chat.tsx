  ...
  return (
    ...
    <section className="mx-auto max-w-2xl px-6 py-32">
      ...
      {/*
        ...
        its avatars with a ring in the surface colour, and a translucent surface
        makes that ring a shade off whatever it happens to be over.
      */}
        ...
        <CardContent className="flex flex-col gap-5">
          ...
          */}
          <div className="flex items-center gap-3">
            ...
            />
            <div className="text-muted/70 flex items-center gap-2 text-xs">
