 ...
 *
 * 1. Avalanche — "alain" and "alaim" must produce visually unrelated avatars.
 ...
 *    adding a trait in a later version cannot disturb existing avatars.
 */
 ...
 * avatars for the same person — which gets reported as a bug, every time.
 */
